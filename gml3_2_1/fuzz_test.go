...
func FuzzReader(f *testing.F) {
	...
	f.Add([]byte(`<gml:CompositeSurface xmlns:gml="http://www.opengis.net/gml/3.2" srsDimension="2"><gml:surfaceMember><gml:Polygon><gml:exterior><gml:LinearRing><gml:posList>0 0 1 0 1 1 0 0</gml:posList></gml:LinearRing></gml:exterior></gml:Polygon></gml:surfaceMember></gml:CompositeSurface>`))
	// CompositeSurface with inline Surface member (multiPolygonFromSurfaceProperty Surface branch)
	f.Add([]byte(`<gml:CompositeSurface xmlns:gml="http://www.opengis.net/gml/3.2" srsDimension="2"><gml:surfaceMember><gml:Surface><gml:patches><gml:PolygonPatch><gml:exterior><gml:LinearRing><gml:posList>0 0 1 0 1 1 0 0</gml:posList></gml:LinearRing></gml:exterior></gml:PolygonPatch></gml:patches></gml:Surface></gml:surfaceMember></gml:CompositeSurface>`))
	...
	// CompositeSurface with inline Shell member (multiPolygonFromSurfaceProperty Shell branch)
	...
	f.Add([]byte(`<gml:OrientableSurface xmlns:gml="http://www.opengis.net/gml/3.2" orientation="+"><gml:baseSurface><gml:CompositeSurface srsDimension="2"><gml:surfaceMember><gml:Polygon><gml:exterior><gml:LinearRing><gml:posList>0 0 1 0 1 1 0 0</gml:posList></gml:LinearRing></gml:exterior></gml:Polygon></gml:surfaceMember></gml:CompositeSurface></gml:baseSurface></gml:OrientableSurface>`))
	// OrientableSurface with Shell base (polygonFromSurfaceProperty Shell branch)
	f.Add([]byte(`<gml:OrientableSurface xmlns:gml="http://www.opengis.net/gml/3.2" orientation="+"><gml:baseSurface><gml:Shell><gml:surfaceMember><gml:Polygon><gml:exterior><gml:LinearRing><gml:posList>0 0 1 0 1 1 0 0</gml:posList></gml:LinearRing></gml:exterior></gml:Polygon></gml:surfaceMember></gml:Shell></gml:baseSurface></gml:OrientableSurface>`))
	f.Add([]byte(`<root/>`))
	f.Add([]byte(``))
