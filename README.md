...
| `gml:Tin` / `gml:TriangulatedSurface` | `MultiPolygon` | ✓ |
| `gml:Grid` / `gml:RectifiedGrid` | `GridCoverage` | ✓ |
| `gml:Solid` | `Solid` | ✓ |
| `gml:CompositeSolid` / `gml:MultiSolid` | `Solid` | ✓ |
...
| `github.com/Kuroki-g/go-gml/citygml2_0` | CityGML 2.0 parser (Building / LoD0–2) |
