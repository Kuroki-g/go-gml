...
func (r *Resolver) resolveBaseAttrsRef(rf rawField, schemaNS string, visiting map[string]bool) []Field {
...
func (r *Resolver) resolveBaseRef(rf rawField, schemaNS string, visiting map[string]bool) []Field {
...
func (r *Resolver) resolveAttrRef(rf rawField, schemaNS string) []Field {
...
func (r *Resolver) resolveGroupRef(rf rawField, schemaNS string, visiting map[string]bool) []Field {
...
func (r *Resolver) resolveChardata(rf rawField, schemaNS string) []Field {
...
func (r *Resolver) resolveLocalField(rf rawField, schemaNS string) []Field {
